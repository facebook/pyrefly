 ...
 */
 ...
 testcase!(
     test_typed_dict_kwargs_overlap,
     r#"
 from typing import TypedDict
 ...
 def foo(x: int, **kwargs: MyDict) -> None:
     pass
 
 d: MyDict = {"x": 1, "y": "hello"}
 foo(x=10, **d)  # E: TypedDict key 'x' in **kwargs overlaps with named parameter 'x'
 "#,
 );