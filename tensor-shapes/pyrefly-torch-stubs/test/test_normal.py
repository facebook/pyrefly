...
def test_normal_tensor_parameter_shapes() -> None:
    ...
    # TODO: BUG: Tensor parameters broadcast to determine the result shape.
    assert_shape(
        torch.normal(broadcast_mean, broadcast_std).shape,
        (2, 1),
        runtime=(2, 3),
    )
...
def test_normal_rejects_different_element_counts() -> None:
    ...
    # TODO: BUG: Reject tensor parameters with different element counts statically.
...
if TYPE_CHECKING:
    ...
    def check_symbolic_normal_broadcast[N: IntVar, M: IntVar](
        ...
        # TODO: BUG: Tensor parameters broadcast to determine the result shape.
        assert_type(torch.normal(mean, std), Tensor[[N, 1]])
