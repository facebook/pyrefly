...
class TestTypeVarArithmetic(unittest.TestCase):
    ...
    def test_typevar_add(self):
        ...
        with self.assertRaisesRegex(
            ...
            def f[N](x: N + 1) -> None:  # type: ignore[valid-type, pyrefly:invalid-annotation]
                pass
    ...
    def test_typevar_mul(self):
        ...
        with self.assertRaisesRegex(
            ...
            def f[N](x: N * 2) -> None:  # type: ignore[valid-type, pyrefly:invalid-annotation]
                pass
    ...
    def test_two_typevars_add(self):
        ...
        with self.assertRaisesRegex(
            ...
            def f[N, M](x: N + M) -> None:  # type: ignore[valid-type, pyrefly:invalid-annotation]
                pass
    ...
    def test_class_typevars_no_arithmetic(self):
        ...
        class Layer[N, M]:
            def forward[B](self, x: torch.Tensor[[B, N]]) -> torch.Tensor[[B, M]]:
                return x  # type: ignore[return-value, pyrefly:bad-return]
