...
if TYPE_CHECKING:
    ...
    def check_current_lstm_return_structure() -> None:
        # TODO: BUG: Model PyTorch's nested `(output, (hidden, cell))` result.
        ...
        # TODO: BUG: Reject LSTM inputs whose feature size does not match.
        nn.LSTM(6, 4, batch_first=True)(torch.ones((2, 5, 7)))
