...
class GenericEncode(nn.Module):
    ...
    def forward[B: IntVar, C: IntVar](
        self, x: Tensor[[B, C]]
    ) -> Tensor[[B, C + 4]]: ...  # type: ignore[pyrefly:bad-return]
...
class GenericDecode(nn.Module):
    ...
    ) -> Tensor[[B, C]]: ...  # type: ignore[pyrefly:bad-return]


class GenericBottleneck(nn.Module):
    """Shape-preserving bottleneck."""

    def forward[B: IntVar, C: IntVar](self, x: Tensor[[B, C]]) -> Tensor[[B, C]]: ...  # type: ignore[pyrefly:bad-return]
...
class Down2d(nn.Module):
    ...
    ) -> Tensor[[B, 2 * C, H // 2, W // 2]]: ...  # type: ignore[pyrefly:bad-return]
...
class Up2d(nn.Module):
    ...
    ) -> Tensor[[B, C, H, W]]: ...  # type: ignore[pyrefly:bad-return]
...
class DownAdd2d(nn.Module):
    ...
    def forward[B: IntVar, C: IntVar, H: IntVar, W: IntVar](
        self, x: Tensor[[B, C, H, W]]
    ) -> Tensor[[B, C + 64, H // 2, W // 2]]: ...  # type: ignore[pyrefly:bad-return]
...
class SymbolicDenseLayer[GR: IntVar](nn.Module):
    ...
    def forward[B: IntVar, C: IntVar, H: IntVar, W: IntVar](
        self, x: Tensor[[B, C, H, W]]
    ) -> Tensor[[B, C + GR, H, W]]: ...  # type: ignore[pyrefly:bad-return]
...
class GenericDenseBlock(nn.Module):
    ...
    def forward[B: IntVar, C: IntVar, H: IntVar, W: IntVar](
        self, x: Tensor[[B, C, H, W]]
    ) -> Tensor[[B, C + 192, H, W]]: ...  # type: ignore[pyrefly:bad-return]
...
class GenericTransition(nn.Module):
    ...
    def forward[B: IntVar, C: IntVar, H: IntVar, W: IntVar](
        self, x: Tensor[[B, C, H, W]]
    ) -> Tensor[[B, C // 2, H // 2, W // 2]]: ...  # type: ignore[pyrefly:bad-return]
...
class DemucsEncoder(nn.Module):
    ...
    def forward[B: IntVar, C: IntVar, T: IntVar](
        self, x: Tensor[[B, C, T]]
    ) -> Tensor[[B, 2 * C, T // 2]]: ...  # type: ignore[pyrefly:bad-return]
...
class DemucsDecoder(nn.Module):
    ...
    ) -> Tensor[[B, C, T]]: ...  # type: ignore[pyrefly:bad-return]
