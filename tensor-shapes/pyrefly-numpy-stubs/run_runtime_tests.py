...
"""Execute the numpy shape-stub suites against the real numpy.

Run this with an interpreter that has numpy installed -- normally the shared
...
def main() -> int:
    ...
    run_suites(library="numpy", package_root=PACKAGE_ROOT, suites=selected)
    return 0
