...
The annotations are generic over a structural array protocol containing a
`shape` property, so the package does not depend on any particular array
library. The test corpus exercises PyTorch, NumPy, and JAX arrays.
