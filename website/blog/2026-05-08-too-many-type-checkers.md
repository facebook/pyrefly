...
I started investigating this, and quickly ran into some roadblocks. Pyrefly is generally stricter than mypy, so it required rewriting parts of the codebase or adding more explicit type annotations when instantiating variables. Finally, I encountered some bugs in Pyrefly, and encouragingly enough, fixes for the vast majority of them were shipped with the highly anticipated [v1 release](https://pyrefly.org/blog/v1.0/). I think it was worth it, especially as it [uncovered a medium-priority bug](https://github.com/pola-rs/polars/issues/27620), but I did have to ask myself whether going through this for another three type-checkers would be.
