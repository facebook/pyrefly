...
export class State {
    ...
    updateSandboxFiles(files) {
        const ret = wasm.state_updateSandboxFiles(this.__wbg_ptr, files);
        if (ret[1]) {
     ...
     */
    updateSingleFile(filename, content) {
        const ptr0 = passStringToWasm0(filename, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.state_updateSingleFile(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    }
    /**
     * @param {string} filename
     */
    setActiveFile(filename) {
        const ptr0 = passStringToWasm0(filename, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.state_setActiveFile(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {any}
     */
