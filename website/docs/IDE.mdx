...
1. Install or update the [`neovim/nvim-lspconfig`](https://github.com/neovim/nvim-lspconfig), [`mason-org/mason.nvim`](https://github.com/mason-org/mason.nvim), and [`mason-org/mason-lspconfig.nvim`](https://github.com/mason-org/mason-lspconfig.nvim) plugins with your plugin manager of choice.2. Add the following to your Neovim `init.lua`:
```lua
require("mason").setup()
...
<details>
    ...
    <details>
        ...
        <details>
            ...
            **NOTE: This file is required to be under `nvim/lsp/pyrefly.lua`
