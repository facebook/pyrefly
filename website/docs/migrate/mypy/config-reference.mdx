...
| `follow_untyped_imports`           | `replace-untyped-imports-with-any`                                                   | Manual                             | Add the applicable module glob, or `"*"` globally, to match mypy's default of not following installed packages that provide neither stubs nor a `py.typed` marker.                                                                                                                            |
