...
| `reportCallIssue`                     | `missing-argument`, `bad-argument-count`, `unexpected-positional-argument`, `unexpected-keyword`, `bad-keyword-argument`, `no-matching-overload`, `incompatible-overload-argument`, `not-callable` | Automatic        | Split        | This is one of the broadest Pyright diagnostics.                                                                    |
