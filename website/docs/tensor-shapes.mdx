...
an alternative front-end to our native syntax. It is disabled by default; set
[`jaxtyping = true`](./configuration.mdx#jaxtyping) to enable it. Supported
annotations are translated internally to use generics and display back in
jaxtyping syntax. See the
