...
can still open the module source when source is available. It can also open direct module
attributes from that source. Other language features do not use the source type information.
